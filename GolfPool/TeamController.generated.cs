...
namespace GolfPool.Controllers
{
    public partial class TeamController
    {
        ...
        protected TeamController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public TeamController Actions { get { return MVC.Team; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Team";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Team";
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Views/Team/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_TeamController : GolfPool.Controllers.TeamController
    {
        public T4MVC_TeamController() : base(Dummy.Instance) { }
